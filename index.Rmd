...
.footer[
Fig. 2 from [S. Chacon and B. Straub. _Pro Git_, Apress](https://git-scm.com/book).
]
...
* According to its [Wikipedia page](https://en.wikipedia.org/wiki/GitHub),
  GitHub has as of January 2023, over 100 million users and more than 420 million
...
* Following the original git implementation, the default branch at GitHub was
  called **master**.  
  &nbsp;&nbsp;
* On October 1st, 2020, GitHub started to
